 ...
 */
package com.example.finalproject.graphics;
...
import com.example.finalproject.models.Group;
import com.example.finalproject.models.Material;
...
public class Model3D extends ARObject implements Serializable{
	...
	public void setXRotat(int angle){
		xrot = angle;
		
	}
	public void setYRotat(int angle){
		yrot = angle;
		
	}
	public void setZRotat(int angle){
		zrot = angle;
